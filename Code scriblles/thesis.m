...
dispersion = 1 ; % ma ter ial  p r o p e r t i e s    f i x e d or wavelength dependent
MyMaterialBuilder(dispersion, wavelength ) ;
    ...
    if dispersion == 0 % no ma ter ia l d i s p e r s i on ; bu i ld TMM s t r u c t u r e on ly once
